...
/**
 *Delete (Stops) scheduled message,If MessageID is specified, only one message is stopped.  Otherwise
 * all messages are stopped
 */
class StopScheduledMessagesResponse implements JsonSerializable
{
    /**
